...
- `causalsim_eval_grid()` for sweeping evaluation across a Cartesian product of DGP parameters
- `causalsim_covar()` for specifying covariate distributions and causal roles
