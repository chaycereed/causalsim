...
For each cell in `expand.grid(vary)`, `causalsim_eval_grid()` takes
`dgp`'s stored original parameters, overrides the cell's values,
reconstructs a new
[`causalsim_dgp()`](https://chaycereed.github.io/causalsim/reference/causalsim_dgp.md),
runs
[`causalsim_eval()`](https://chaycereed.github.io/causalsim/reference/causalsim_eval.md),
...
grid_result
#> <causalsim_eval_grid>  3 cells  vary: n  reps/cell: 50
